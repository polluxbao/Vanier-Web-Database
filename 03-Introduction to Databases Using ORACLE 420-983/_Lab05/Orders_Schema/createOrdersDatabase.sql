...
CREATE TABLE office_employees (
  ...
  CONSTRAINT office_employees_ibfk_1 FOREIGN KEY (reportsTo) REFERENCES office_employees (employeeNumber),
  CONSTRAINT office_employees_ibfk_2 FOREIGN KEY (officeCode) REFERENCES offices (officeCode)
);


CREATE INDEX IDX_reportsTo ON office_employees (reportsTo);

CREATE INDEX IDXofficeCode ON office_employees ( officeCode );


/*Data for the table office_employees */

insert  into office_employees(employeeNumber,lastName,firstName,extension,email,officeCode,reportsTo,jobTitle) values (1002,'Murphy','Diane','x5800','dmurphy@classicmodelcars.com','1',NULL,'President');
insert  into office_employees(employeeNumber,lastName,firstName,extension,email,officeCode,reportsTo,jobTitle) values (1056,'Patterson','Mary','x4611','mpatterso@classicmodelcars.com','1',1002,'VP Sales');
insert  into office_employees(employeeNumber,lastName,firstName,extension,email,officeCode,reportsTo,jobTitle) values (1076,'Firrelli','Jeff','x9273','jfirrelli@classicmodelcars.com','1',1002,'VP Marketing');
insert  into office_employees(employeeNumber,lastName,firstName,extension,email,officeCode,reportsTo,jobTitle) values (1088,'Patterson','William','x4871','wpatterson@classicmodelcars.com','6',1056,'Sales Manager (APAC)');
insert  into office_employees(employeeNumber,lastName,firstName,extension,email,officeCode,reportsTo,jobTitle) values (1102,'Bondur','Gerard','x5408','gbondur@classicmodelcars.com','4',1056,'Sale Manager (EMEA)');
insert  into office_employees(employeeNumber,lastName,firstName,extension,email,officeCode,reportsTo,jobTitle) values (1143,'Bow','Anthony','x5428','abow@classicmodelcars.com','1',1056,'Sales Manager (NA)');
insert  into office_employees(employeeNumber,lastName,firstName,extension,email,officeCode,reportsTo,jobTitle) values (1165,'Jennings','Leslie','x3291','ljennings@classicmodelcars.com','1',1143,'Sales Rep');
insert  into office_employees(employeeNumber,lastName,firstName,extension,email,officeCode,reportsTo,jobTitle) values (1166,'Thompson','Leslie','x4065','lthompson@classicmodelcars.com','1',1143,'Sales Rep');
insert  into office_employees(employeeNumber,lastName,firstName,extension,email,officeCode,reportsTo,jobTitle) values (1188,'Firrelli','Julie','x2173','jfirrelli@classicmodelcars.com','2',1143,'Sales Rep');
insert  into office_employees(employeeNumber,lastName,firstName,extension,email,officeCode,reportsTo,jobTitle) values (1216,'Patterson','Steve','x4334','spatterson@classicmodelcars.com','2',1143,'Sales Rep');
insert  into office_employees(employeeNumber,lastName,firstName,extension,email,officeCode,reportsTo,jobTitle) values (1286,'Tseng','Foon Yue','x2248','ftseng@classicmodelcars.com','3',1143,'Sales Rep');
insert  into office_employees(employeeNumber,lastName,firstName,extension,email,officeCode,reportsTo,jobTitle) values (1323,'Vanauf','George','x4102','gvanauf@classicmodelcars.com','3',1143,'Sales Rep');
insert  into office_employees(employeeNumber,lastName,firstName,extension,email,officeCode,reportsTo,jobTitle) values (1337,'Bondur','Loui','x6493','lbondur@classicmodelcars.com','4',1102,'Sales Rep');
insert  into office_employees(employeeNumber,lastName,firstName,extension,email,officeCode,reportsTo,jobTitle) values (1370,'Hernandez','Gerard','x2028','ghernande@classicmodelcars.com','4',1102,'Sales Rep');
insert  into office_employees(employeeNumber,lastName,firstName,extension,email,officeCode,reportsTo,jobTitle) values (1401,'Castillo','Pamela','x2759','pcastillo@classicmodelcars.com','4',1102,'Sales Rep');
insert  into office_employees(employeeNumber,lastName,firstName,extension,email,officeCode,reportsTo,jobTitle) values (1501,'Bott','Larry','x2311','lbott@classicmodelcars.com','7',1102,'Sales Rep');
insert  into office_employees(employeeNumber,lastName,firstName,extension,email,officeCode,reportsTo,jobTitle) values (1504,'Jones','Barry','x102','bjones@classicmodelcars.com','7',1102,'Sales Rep');
insert  into office_employees(employeeNumber,lastName,firstName,extension,email,officeCode,reportsTo,jobTitle) values (1611,'Fixter','Andy','x101','afixter@classicmodelcars.com','6',1088,'Sales Rep');
insert  into office_employees(employeeNumber,lastName,firstName,extension,email,officeCode,reportsTo,jobTitle) values (1612,'Marsh','Peter','x102','pmarsh@classicmodelcars.com','6',1088,'Sales Rep');
insert  into office_employees(employeeNumber,lastName,firstName,extension,email,officeCode,reportsTo,jobTitle) values (1619,'King','Tom','x103','tking@classicmodelcars.com','6',1088,'Sales Rep');
insert  into office_employees(employeeNumber,lastName,firstName,extension,email,officeCode,reportsTo,jobTitle) values (1621,'Nishi','Mami','x101','mnishi@classicmodelcars.com','5',1056,'Sales Rep');
insert  into office_employees(employeeNumber,lastName,firstName,extension,email,officeCode,reportsTo,jobTitle) values (1625,'Kato','Yoshimi','x102','ykato@classicmodelcars.com','5',1621,'Sales Rep');
insert  into office_employees(employeeNumber,lastName,firstName,extension,email,officeCode,reportsTo,jobTitle) values (1702,'Gerard','Martin','x2312','mgerard@classicmodelcars.com','4',1102,'Sales Rep');
...
CREATE TABLE customers (
  ...
  CONSTRAINT customers_ibfk_1 FOREIGN KEY (salesRepEmployeeNumber) REFERENCES office_employees (employeeNumber)
);

CREATE INDEX IDXsalesRepEmployeeNumber ON customers (salesRepEmployeeNumber);
...
insert  into customers(customerNumber,customerName,contactLastName,contactFirstName,phone,addressLine1,addressLine2,city,state,postalCode,country,salesRepEmployeeNumber,creditLimit) values (144,'Volvo Model Replicas, Co','Berglund','Christina ','0921-12 3555','Berguvsvagen  8',NULL,'Luleå',NULL,'S-958 22','Sweden',1504,'53100.00');
insert  into customers(customerNumber,customerName,contactLastName,contactFirstName,phone,addressLine1,addressLine2,city,state,postalCode,country,salesRepEmployeeNumber,creditLimit) values (145,'Danish Wholesale Imports','Petersen','Jytte ','31 12 3555','Vinbæltet 34',NULL,'Kobenhavn',NULL,'1734','Denmark',1401,'83400.00');
insert  into customers(customerNumber,customerName,contactLastName,contactFirstName,phone,addressLine1,addressLine2,city,state,postalCode,country,salesRepEmployeeNumber,creditLimit) values (146,'Saveley ' || chr(38) || ' Henriot, Co.','Saveley','Mary ','78.32.5555','2, rue du Commerce',NULL,'Lyon',NULL,'69004','France',1337,'123900.00');
...
insert  into customers(customerNumber,customerName,contactLastName,contactFirstName,phone,addressLine1,addressLine2,city,state,postalCode,country,salesRepEmployeeNumber,creditLimit) values (219,'Boards ' || chr(38) || ' Toys Co.','Young','Mary','3105552373','4097 Douglas Av.',NULL,'Glendale','CA','92561','USA',1166,'11000.00');
...
insert  into customers(customerNumber,customerName,contactLastName,contactFirstName,phone,addressLine1,addressLine2,city,state,postalCode,country,salesRepEmployeeNumber,creditLimit) values (249,'Amica Models ' || chr(38) || ' Co.','Accorti','Paolo ','011-4988555','Via Monte Bianco 34',NULL,'Torino',NULL,'10100','Italy',1401,'113000.00');
...
insert  into customers(customerNumber,customerName,contactLastName,contactFirstName,phone,addressLine1,addressLine2,city,state,postalCode,country,salesRepEmployeeNumber,creditLimit) values (256,'Auto Associés ' || chr(38) || ' Cie.','Tonini','Daniel ','30.59.8555','67, avenue de l''Europe',NULL,'Versailles',NULL,'78000','France',1370,'77900.00');
...
insert  into customers(customerNumber,customerName,contactLastName,contactFirstName,phone,addressLine1,addressLine2,city,state,postalCode,country,salesRepEmployeeNumber,creditLimit) values (293,'BG' || chr(38) || 'E Collectables','Harrison','Ed','+41 26 425 50 01','Rte des Arsenaux 41 ',NULL,'Fribourg',NULL,'1700','Switzerland',NULL,'0.00');
...
insert  into customers(customerNumber,customerName,contactLastName,contactFirstName,phone,addressLine1,addressLine2,city,state,postalCode,country,salesRepEmployeeNumber,creditLimit) values (385,'Cruz ' || chr(38) || ' Sons Co.','Cruz','Arnold','+63 2 555 3587','15 McCallum Street','NatWest Center #13-03','Makati City',NULL,'1227 MM','Philippines',1621,'81500.00');
...
insert  into customers(customerNumber,customerName,contactLastName,contactFirstName,phone,addressLine1,addressLine2,city,state,postalCode,country,salesRepEmployeeNumber,creditLimit) values (477,'Mit Vergnügen ' || chr(38) || ' Co.','Moos','Hanna ','0621-08555','Forsterstr. 57',NULL,'Mannheim',NULL,'68306','Germany',NULL,'0.00');
...
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (103,'OM314933','2004-12-18','1676.14');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (112,'BO864823','2004-12-17','14191.12');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (112,'HQ55022','2003-06-06','32641.98');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (112,'ND748579','2004-08-20','33347.88');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (114,'GG31455','2003-05-20','45864.03');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (114,'MA765515','2004-12-15','82261.22');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (114,'NP603840','2003-05-31','7565.08');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (114,'NR27552','2004-03-10','44894.74');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (119,'DB933704','2004-11-14','19501.82');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (119,'LN373447','2004-08-08','47924.19');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (119,'NG94694','2005-02-22','49523.67');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (121,'DB889831','2003-02-16','50218.95');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (121,'FD317790','2003-10-28','1491.38');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (121,'KI831359','2004-11-04','17876.32');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (121,'MA302151','2004-11-28','34638.14');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (124,'AE215433','2005-03-05','101244.59');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (124,'BG255406','2004-08-28','85410.87');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (124,'CQ287967','2003-04-11','11044.30');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (124,'ET64396','2005-04-16','83598.04');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (124,'HI366474','2004-12-27','47142.70');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (124,'HR86578','2004-11-02','55639.66');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (124,'KI131716','2003-08-15','111654.40');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (124,'LF217299','2004-03-26','43369.30');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (124,'NT141748','2003-11-25','45084.38');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (128,'DI925118','2003-01-28','10549.01');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (128,'FA465482','2003-10-18','24101.81');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (128,'FH668230','2004-03-24','33820.62');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (128,'IP383901','2004-11-18','7466.32');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (129,'DM826140','2004-12-08','26248.78');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (129,'ID449593','2003-12-11','23923.93');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (129,'PI42991','2003-04-09','16537.85');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (131,'CL442705','2003-03-12','22292.62');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (131,'MA724562','2004-12-02','50025.35');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (131,'NB445135','2004-09-11','35321.97');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (141,'AU364101','2003-07-19','36251.03');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (141,'DB583216','2004-11-01','36140.38');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (141,'DL460618','2005-05-19','46895.48');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (141,'HJ32686','2004-01-30','59830.55');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (141,'ID10962','2004-12-31','116208.40');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (141,'IN446258','2005-03-25','65071.26');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (141,'JE105477','2005-03-18','120166.58');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (141,'JN355280','2003-10-26','49539.37');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (141,'JN722010','2003-02-25','40206.20');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (141,'KT52578','2003-12-09','63843.55');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (141,'MC46946','2004-07-09','35420.74');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (141,'MF629602','2004-08-16','20009.53');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (141,'NU627706','2004-05-17','26155.91');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (144,'IR846303','2004-12-12','36005.71');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (144,'LA685678','2003-04-09','7674.94');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (145,'CN328545','2004-07-03','4710.73');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (145,'ED39322','2004-04-26','28211.70');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (145,'HR182688','2004-12-01','20564.86');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (145,'JJ246391','2003-02-20','53959.21');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (146,'FP549817','2004-03-18','40978.53');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (146,'FU793410','2004-01-16','49614.72');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (146,'LJ160635','2003-12-10','39712.10');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (148,'BI507030','2003-04-22','44380.15');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (148,'DD635282','2004-08-11','2611.84');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (148,'KM172879','2003-12-26','105743.00');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (148,'ME497970','2005-03-27','3516.04');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (151,'BF686658','2003-12-22','58793.53');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (151,'GB852215','2004-07-26','20314.44');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (151,'IP568906','2003-06-18','58841.35');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (151,'KI884577','2004-12-14','39964.63');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (157,'HI618861','2004-11-19','35152.12');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (157,'NN711988','2004-09-07','63357.13');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (161,'BR352384','2004-11-14','2434.25');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (161,'BR478494','2003-11-18','50743.65');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (161,'KG644125','2005-02-02','12692.19');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (161,'NI908214','2003-08-05','38675.13');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (166,'BQ327613','2004-09-16','38785.48');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (166,'DC979307','2004-07-07','44160.92');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (166,'LA318629','2004-02-28','22474.17');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (167,'ED743615','2004-09-19','12538.01');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (167,'GN228846','2003-12-03','85024.46');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (171,'GB878038','2004-03-15','18997.89');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (171,'IL104425','2003-11-22','42783.81');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (172,'AD832091','2004-09-09','1960.80');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (172,'CE51751','2004-12-04','51209.58');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (172,'EH208589','2003-04-20','33383.14');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (173,'GP545698','2004-05-13','11843.45');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (173,'IG462397','2004-03-29','20355.24');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (175,'CITI3434344','2005-05-19','28500.78');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (175,'IO448913','2003-11-19','24879.08');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (175,'PI15215','2004-07-10','42044.77');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (177,'AU750837','2004-04-17','15183.63');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (177,'CI381435','2004-01-19','47177.59');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (181,'CM564612','2004-04-25','22602.36');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (181,'GQ132144','2003-01-30','5494.78');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (181,'OH367219','2004-11-16','44400.50');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (186,'AE192287','2005-03-10','23602.90');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (186,'AK412714','2003-10-27','37602.48');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (186,'KA602407','2004-10-21','34341.08');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (187,'AM968797','2004-11-03','52825.29');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (187,'BQ39062','2004-12-08','47159.11');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (187,'KL124726','2003-03-27','48425.69');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (189,'BO711618','2004-10-03','17359.53');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (189,'NM916675','2004-03-01','32538.74');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (198,'FI192930','2004-12-06','9658.74');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (198,'HQ920205','2003-07-06','6036.96');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (198,'IS946883','2004-09-21','5858.56');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (201,'DP677013','2003-10-20','23908.24');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (201,'OO846801','2004-06-15','37258.94');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (202,'HI358554','2003-12-18','36527.61');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (202,'IQ627690','2004-11-08','33594.58');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (204,'GC697638','2004-08-13','51152.86');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (204,'IS150005','2004-09-24','4424.40');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (205,'GL756480','2003-12-04','3879.96');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (205,'LL562733','2003-09-05','50342.74');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (205,'NM739638','2005-02-06','39580.60');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (209,'BOAF82044','2005-05-03','35157.75');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (209,'ED520529','2004-06-21','4632.31');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (209,'PH785937','2004-05-04','36069.26');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (211,'BJ535230','2003-12-09','45480.79');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (216,'BG407567','2003-05-09','3101.40');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (216,'ML780814','2004-12-06','24945.21');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (216,'MM342086','2003-12-14','40473.86');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (219,'BN17870','2005-03-02','3452.75');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (219,'BR941480','2003-10-18','4465.85');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (227,'MQ413968','2003-10-31','36164.46');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (227,'NU21326','2004-11-02','53745.34');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (233,'BOFA23232','2005-05-20','29070.38');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (233,'II180006','2004-07-01','22997.45');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (233,'JG981190','2003-11-18','16909.84');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (239,'NQ865547','2004-03-15','80375.24');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (240,'IF245157','2004-11-16','46788.14');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (240,'JO719695','2004-03-28','24995.61');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (242,'AF40894','2003-11-22','33818.34');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (242,'HR224331','2005-06-03','12432.32');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (242,'KI744716','2003-07-21','14232.70');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (249,'IJ399820','2004-09-19','33924.24');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (249,'NE404084','2004-09-04','48298.99');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (250,'EQ12267','2005-05-17','17928.09');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (250,'HD284647','2004-12-30','26311.63');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (250,'HN114306','2003-07-18','23419.47');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (256,'EP227123','2004-02-10','5759.42');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (256,'HE84936','2004-10-22','53116.99');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (259,'EU280955','2004-11-06','61234.67');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (259,'GB361972','2003-12-07','27988.47');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (260,'IO164641','2004-08-30','37527.58');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (260,'NH776924','2004-04-24','29284.42');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (276,'EM979878','2005-02-09','27083.78');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (276,'KM841847','2003-11-13','38547.19');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (276,'LE432182','2003-09-28','41554.73');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (276,'OJ819725','2005-04-30','29848.52');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (278,'BJ483870','2004-12-05','37654.09');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (278,'GP636783','2003-03-02','52151.81');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (278,'NI983021','2003-11-24','37723.79');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (282,'IA793562','2003-08-03','24013.52');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (282,'JT819493','2004-08-02','35806.73');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (282,'OD327378','2005-01-03','31835.36');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (286,'DR578578','2004-10-28','47411.33');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (286,'KH910279','2004-09-05','43134.04');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (298,'AJ574927','2004-03-13','47375.92');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (298,'LF501133','2004-09-18','61402.00');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (299,'AD304085','2003-10-24','36798.88');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (299,'NR157385','2004-09-05','32260.16');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (311,'DG336041','2005-02-15','46770.52');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (311,'FA728475','2003-10-06','32723.04');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (311,'NQ966143','2004-04-25','16212.59');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (314,'LQ244073','2004-08-09','45352.47');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (314,'MD809704','2004-03-03','16901.38');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (319,'HL685576','2004-11-06','42339.76');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (319,'OM548174','2003-12-07','36092.40');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (320,'GJ597719','2005-01-18','8307.28');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (320,'HO576374','2003-08-20','41016.75');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (320,'MU817160','2003-11-24','52548.49');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (321,'DJ15149','2003-11-03','85559.12');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (321,'LA556321','2005-03-15','46781.66');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (323,'AL493079','2005-05-23','75020.13');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (323,'ES347491','2004-06-24','37281.36');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (323,'HG738664','2003-07-05','2880.00');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (323,'PQ803830','2004-12-24','39440.59');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (324,'DQ409197','2004-12-13','13671.82');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (324,'FP443161','2003-07-07','29429.14');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (324,'HB150714','2003-11-23','37455.77');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (328,'EN930356','2004-04-16','7178.66');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (328,'NR631421','2004-05-30','31102.85');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (333,'HL209210','2003-11-15','23936.53');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (333,'JK479662','2003-10-17','9821.32');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (333,'NF959653','2005-03-01','21432.31');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (334,'CS435306','2005-01-27','45785.34');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (334,'HH517378','2003-08-16','29716.86');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (334,'LF737277','2004-05-22','28394.54');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (339,'AP286625','2004-10-24','23333.06');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (339,'DA98827','2003-11-28','34606.28');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (344,'AF246722','2003-11-24','31428.21');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (344,'NJ906924','2004-04-02','15322.93');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (347,'DG700707','2004-01-18','21053.69');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (347,'LG808674','2003-10-24','20452.50');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (350,'BQ602907','2004-12-11','18888.31');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (350,'CI471510','2003-05-25','50824.66');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (350,'OB648482','2005-01-29','1834.56');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (353,'CO351193','2005-01-10','49705.52');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (353,'ED878227','2003-07-21','13920.26');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (353,'GT878649','2003-05-21','16700.47');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (353,'HJ618252','2005-06-09','46656.94');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (357,'AG240323','2003-12-16','20220.04');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (357,'NB291497','2004-05-15','36442.34');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (362,'FP170292','2004-07-11','18473.71');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (362,'OG208861','2004-09-21','15059.76');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (363,'HL575273','2004-11-17','50799.69');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (363,'IS232033','2003-01-16','10223.83');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (363,'PN238558','2003-12-05','55425.77');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (379,'CA762595','2005-02-12','28322.83');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (379,'FR499138','2003-09-16','32680.31');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (379,'GB890854','2004-08-02','12530.51');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (381,'BC726082','2004-12-03','12081.52');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (381,'CC475233','2003-04-19','1627.56');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (381,'GB117430','2005-02-03','14379.90');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (381,'MS154481','2003-08-22','1128.20');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (382,'CC871084','2003-05-12','35826.33');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (382,'CT821147','2004-08-01','6419.84');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (382,'PH29054','2004-11-27','42813.83');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (385,'BN347084','2003-12-02','20644.24');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (385,'CP804873','2004-11-19','15822.84');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (385,'EK785462','2003-03-09','51001.22');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (386,'DO106109','2003-11-18','38524.29');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (386,'HG438769','2004-07-18','51619.02');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (398,'AJ478695','2005-02-14','33967.73');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (398,'DO787644','2004-06-21','22037.91');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (398,'JPMR4544','2005-05-18','615.45');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (398,'KB54275','2004-11-29','48927.64');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (406,'BJMPR4545','2005-04-23','12190.85');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (406,'HJ217687','2004-01-28','49165.16');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (406,'NA197101','2004-06-17','25080.96');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (412,'GH197075','2004-07-25','35034.57');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (412,'PJ434867','2004-04-14','31670.37');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (415,'ER54537','2004-09-28','31310.09');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (424,'KF480160','2004-12-07','25505.98');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (424,'LM271923','2003-04-16','21665.98');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (424,'OA595449','2003-10-31','22042.37');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (447,'AO757239','2003-09-15','6631.36');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (447,'ER615123','2003-06-25','17032.29');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (447,'OU516561','2004-12-17','26304.13');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (448,'FS299615','2005-04-18','27966.54');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (448,'KR822727','2004-09-30','48809.90');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (450,'EF485824','2004-06-21','59551.38');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (452,'ED473873','2003-11-15','27121.90');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (452,'FN640986','2003-11-20','15130.97');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (452,'HG635467','2005-05-03','8807.12');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (455,'HA777606','2003-12-05','38139.18');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (455,'IR662429','2004-05-12','32239.47');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (456,'GJ715659','2004-11-13','27550.51');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (456,'MO743231','2004-04-30','1679.92');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (458,'DD995006','2004-11-15','33145.56');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (458,'NA377824','2004-02-06','22162.61');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (458,'OO606861','2003-06-13','57131.92');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (462,'ED203908','2005-04-15','30293.77');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (462,'GC60330','2003-11-08','9977.85');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (462,'PE176846','2004-11-27','48355.87');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (471,'AB661578','2004-07-28','9415.13');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (471,'CO645196','2003-12-10','35505.63');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (473,'LL427009','2004-02-17','7612.06');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (473,'PC688499','2003-10-27','17746.26');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (475,'JP113227','2003-12-09','7678.25');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (475,'PB951268','2004-02-13','36070.47');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (484,'GK294076','2004-10-26','3474.66');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (484,'JH546765','2003-11-29','47513.19');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (486,'BL66528','2004-04-14','5899.38');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (486,'HS86661','2004-11-23','45994.07');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (486,'JB117768','2003-03-20','25833.14');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (487,'AH612904','2003-09-28','29997.09');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (487,'PT550181','2004-02-29','12573.28');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (489,'OC773849','2003-12-04','22275.73');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (489,'PO860906','2004-01-31','7310.42');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (495,'BH167026','2003-12-26','59265.14');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (495,'FN155234','2004-05-14','6276.60');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (496,'EU531600','2005-05-25','30253.75');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (496,'MB342426','2003-07-16','32077.44');
insert  into payments(customerNumber,checkNumber,paymentDate,amount) values (496,'MN89921','2004-12-31','52166.00');
...
insert  into products(productCode,productName,productLine,productScale,productVendor,productDescription,quantityInStock,buyPrice,MSRP) values ('S12_1666','1958 Setra Bus','Trucks and Buses','1:12','Welly Diecast Productions','Model features 30 windows, skylights ' || chr(38) || ' glare resistant glass, working steering system, original logos',1579,'77.90','136.67');
...
insert  into products(productCode,productName,productLine,productScale,productVendor,productDescription,quantityInStock,buyPrice,MSRP) values ('S32_2509','1954 Greyhound Scenicruiser','Trucks and Buses','1:32','Classic Metal Creations','Model features bi-level seating, 50 windows, skylights ' || chr(38) || ' glare resistant glass, working steering system, original logos',2874,'25.98','54.11');
...
insert  into orderdetails(orderNumber,productCode,quantityOrdered,priceEach,orderLineNumber) values (10105,'S32_3207',41,'75.48',10);
insert  into orderdetails(orderNumber,productCode,quantityOrdered,priceEach,orderLineNumber) values (10105,'S50_1514',43,'117.97',9);
